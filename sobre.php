	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-8 col-xs-12 content">
				...
				<p>Atuo com desenvolvimento backend de novas features em interfaces PHP utlizando frameworks Codeigniter
				e Yii e API's Java (7/8) utilizando serviços Rest, ORM Hibernate, Framework Spring, servidores Jboss e Tomcat.<p>
				<p>Ao longo de mais de 6 anos de experência participei de dezenas de projetos de desenvolvento de sites,
			...
			<div class="col-sm-4 col-xs-12">
				<div class="text-effect">
					...
					<div class="fields">
						<span class="word1">PHP</span>
						<span class="word1">JAVA</span>
						<span class="word1">MYSQL</span>
						<span class="word2">JQUERY</span>
						<span class="word2">HTML</span>
						<span class="word2">CSS</span>
					</div>
				</div>
			</div>
